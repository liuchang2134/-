...
function diagramSvg(type, color) {
  const diagrams = {
    ...
    signal: { levels: [[150, "支撑"]], path: "M24 82 L70 116 L112 148 L154 138 L194 100 L238 72 L286 58", candles: [[50,82,116,78,120],[92,116,148,112,152],[134,148,138,132,154],[176,138,100,96,142],[218,100,72,68,104],[260,72,58,54,78]], label: "关键位置的信号K" },
    trend: { levels: [], path: "M24 158 L64 126 L102 140 L142 104 L180 118 L220 82 L286 52", candles: [[46,158,126,122,162],[86,126,140,122,144],[126,140,104,100,144],[166,104,118,100,122],[206,118,82,78,122],[254,82,52,48,86]], label: "Always In Long" },
    ...
    measured: { levels: [[154, "突破点"], [58, "MM目标"]], path: "M24 154 L72 104 L118 72 L160 116 L206 82 L286 58", candles: [[52,150,104,100,156],[96,104,72,68,108],[142,72,116,68,122],[190,116,82,76,120],[244,82,58,52,86]], label: "Leg 1 = Leg 2" },
    ...
    system: { levels: [[96, "规则"], [150, "复盘"]], path: "M24 150 L70 126 L116 136 L160 110 L206 96 L252 116 L286 86", candles: [[52,150,126,122,154],[96,126,136,122,140],[140,136,110,106,140],[186,110,96,92,114],[230,96,116,92,120],[268,116,86,82,120]], label: "固定一种 setup" },
